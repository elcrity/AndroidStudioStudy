...
class DogCardAdapter(
    ...
    private val dogInfo = DataSource.dogs
    ...
    override fun getItemCount(): Int = dogInfo.size // TODO: return the size of the data set instead of 0

    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        // TODO: Get the data at the current position
        val dog = dogInfo[position]
        ...
        // = dog.hobbies를 사용시 hobbies : text가 아닌 text만 출력
    }
}
